                ...
                <div className='relative md:px-16 py-16 px-6 md:py-24'>
                    ...
                    <div className='relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12'>
                        ...
                        <div className='text-white max-w-lg text-center md:text-left'>
                            <h2 className='text-2xl sm:text-3xl lg:text-4xl font-medium mb-4'>Subscribe Newslatter</h2>
                            <p className='text-blue-100 text-sm sm:text-base'>Best cooks and best delivery guys all at your service. Hot tast food</p>
                        </div>
